...
#ifndef _VARIANT_CRUMBUINO_MEGA_
#define _VARIANT_CRUMBUINO_MEGA_
#endif
...
const uint8_t PROGMEM digital_pin_to_timer_PGM[] = {
	...
	NOT_ON_TIMER, // PF 3 ** 71 ** A3
	NOT_ON_TIMER, // PF 4 ** 72 ** A4
	NOT_ON_TIMER, // PF 5 ** 73 ** A5
	NOT_ON_TIMER, // PF 6 ** 74 ** A6
	NOT_ON_TIMER, // PF 7 ** 75 ** A7
	NOT_ON_TIMER, // PK 0 ** 76 ** A8
	NOT_ON_TIMER, // PK 1 ** 77 ** A9
	NOT_ON_TIMER, // PK 2 ** 78 ** A10
	NOT_ON_TIMER, // PK 3 ** 79 ** A11
	NOT_ON_TIMER, // PK 4 ** 80 ** A12
	NOT_ON_TIMER, // PK 5 ** 81 ** A13
	NOT_ON_TIMER, // PK 6 ** 82 ** A14
	NOT_ON_TIMER, // PK 7 ** 83 ** A15
};
